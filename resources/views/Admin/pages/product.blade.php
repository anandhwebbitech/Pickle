                    ...
                    <div class="modal-body">
                        <div class="row g-3">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="number" step="0.01" name="quantity" class="form-control" placeholder="Eg: 1.5">
                            </div>
                            ...
                            <div class="col-md-12">
                                ...
                                <div id="weightPriceWrapper">
                                    <div class="row mb-2 weight-row">
                                        <div class="col-md-4">
                                            <input type="text" name="weights[0][weight]" class="form-control" placeholder="Weight (eg: 250g)">
                                        </div>

                                        <div class="col-md-4">
                                            <input type="number" name="weights[0][price]" class="form-control" placeholder="Price (₹)">
                                        </div>

                                        <div class="col-md-2">
                                            <button type="button"
                                                class="btn btn-success btn-sm addWeightPrice"
                            ...
                            <div class="col-md-12">
                                ...
                                <div id="containsWrapper">
                                    <div class="row mb-2">
                                        <div class="col-md-10">
                                            <input type="text" name="contains[]" class="form-control" placeholder="Eg: Mustard, Garlic">
                                        </div>
                                        <div class="col-md-2">
                                            ...
                                            <button type="button"
                                                class="btn btn-primary btn-sm addContains"
                                                style="border-radius:25px; padding:7px 10px;">
                                                <i class="fa fa-plus"></i>
                                            </button>
                                        </div>
                ...
                <div class="modal-body">
                    <div class="row g-3">
                        ...
                        <div class="col-md-4 d-flex gap-4 mt-4">
                            <div class="form-check">
                                <input type="checkbox" name="deals" id="edit_deals" value="1" class="form-check-input">
                                <label class="form-check-label">Deals</label>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12">
                            ...
                            <button type="button"
                                class="btn btn-success btn-sm addEditWeight mt-2">
                        ...
                        <div class="col-md-12">
                            ...
                            <!-- <div id="editContainsWrapper"></div> -->
                             <div id="editContainsWrapper"></div>
                            <button type="button"
                                class="btn btn-primary btn-sm addEditContains mt-2">
...
<script>
    ...
    $('#addProductForm').submit(function(e) {
        ...
        $.ajax({
            url: "{{ route('products.store') }}", // ✅ change if needed
            method: "POST",
            data: formData,
            contentType: false,
            processData: false,
            ...
            success: function(response) {
                ...
                $('#weightPriceWrapper').html(''); // clear dynamic rows
